...
$jurusan = isset($_GET['jurusan']) ? $_GET['jurusan'] : 'teknik';
?>
...
<head>
<meta charset="UTF-8">
<title>Tambah Soal Tes - <?php echo ($jurusan == 'teknik') ? 'Teknik' : 'Non Teknik'; ?></title>
...
.btn-main {
    background: linear-gradient(135deg, #0d3b66, #198754);
    color: white;
    font-weight: 800;
    border-radius: 14px;
    padding: 11px 20px;
    ...
    <div class="box">
        <div class="mb-3">
            <div class="page-title">
                <i class="bi bi-gear-fill"></i> Tambah Soal Tes <?php echo ($jurusan == 'teknik') ? 'Teknik' : 'Non Teknik'; ?>
                <span class="badge-teknik">Jurusan <?php echo ($jurusan == 'teknik') ? 'Teknik' : 'Non Teknik'; ?></span>
            </div>
            <div class="page-sub">Masukkan soal untuk jurusan <?php echo ($jurusan == 'teknik') ? 'teknik' : 'non teknik'; ?> secara manual atau upload via CSV</div>
        </div>
        ...
        <?php if(isset($_GET['msg']) && $_GET['msg'] == 'success'): ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <i class="bi bi-check-circle-fill"></i> <strong>Berhasil!</strong> Soal berhasil ditambahkan.
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
        <?php elseif(isset($_GET['msg']) && $_GET['msg'] == 'error'): ?>
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <i class="bi bi-exclamation-triangle-fill"></i> <strong>Gagal!</strong> Terjadi kesalahan. Silakan coba lagi.
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
        <?php elseif(isset($_GET['msg']) && $_GET['msg'] == 'csv_success'): ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <i class="bi bi-check-circle-fill"></i> <strong>Berhasil!</strong> Soal dari CSV berhasil ditambahkan.
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
        <?php elseif(isset($_GET['msg']) && $_GET['msg'] == 'csv_error'): ?>
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <i class="bi bi-exclamation-triangle-fill"></i> <strong>Gagal!</strong> Terjadi kesalahan saat memproses CSV. Pastikan format file sesuai.
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
        <?php endif; ?>
        ...
        <form action="proses_soal.php" method="POST" enctype="multipart/form-data" id="soalForm">
            ...
            <div class="csv-section">
                ...
                <div class="mb-3">
                    ...
                    <small class="text-muted d-block mt-2">
                        ...
                        <strong>Contoh:</strong> "Apa itu resistor?",Resistor adalah komponen untuk membatasi arus,Komponen untuk mengalirkan arus,Komponen untuk menyimpan energi,Komponen untuk menguatkan sinyal,,A
                    </small>
                </div>
                
                <div class="mt-2">
                    <a href="template_soal_<?php echo $jurusan; ?>.csv" class="btn-back" style="padding: 6px 15px; font-size: 12px;">
            ...
            <div class="d-flex gap-3 mt-4">
                <button type="submit" class="btn-main" id="submitBtn">
                    <i class="bi bi-check-circle-fill"></i> Simpan Soal
                </button>
                <a href="soal_tes.php?jurusan=<?php echo $jurusan; ?>&show_soal=show" class="btn-back">
...
document.getElementById('soalForm').addEventListener('submit', function(e) {
    ...
    // Jika ada file CSV yang dipilih
    if(csvFile) {
...
document.getElementById('csvFile').addEventListener('change', function() {
    ...
    if(this.files.length > 0) {
        ...
        submitBtn.innerHTML = '<i class="bi bi-check-circle-fill"></i> Simpan Soal';
        submitBtn.style.background = "linear-gradient(135deg, #0d3b66, #198754)";
    }
});
</script>
